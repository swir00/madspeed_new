              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    // Dynamicznie pokazuj czas trwania na podstawie danych z BLEService
                    ValueListenableBuilder<Duration>(
                      valueListenable: bleService.trainingDuration,
                      builder: (context, duration, child) {
                        // Pokaż timer, jeśli logowanie jest aktywne LUB jeśli timer ma wartość > 0
                        // (przydatne, gdy połączenie zerwie się na chwilę, a logowanie było aktywne)
                        if (isLoggingActiveFromDevice || duration > Duration.zero) {
                          return _buildMeasurementRow(
                              'Czas trwania:', _formatDuration(duration), '');
                        }
                        return const SizedBox.shrink(); // Ukryj, jeśli niepotrzebne
                      },
                    ),
